...
I just found out I passed CFA level III
...
#|
Your answer here
The new-if function doesn't work because 'then-case' is always evaluated when using new-if,
but if is a special form and the second argument is only evaluated when the first argument is true.
|#
